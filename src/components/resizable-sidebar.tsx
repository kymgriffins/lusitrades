...
export default function ResizableSidebar({ user }: ResizableSidebarProps) {
          ...
          {!isCollapsed && (
            <div className="mx-2 mb-4">
              <div className="bg-gradient-to-br from-cyan-500/10 to-purple-500/20 border border-cyan-400/20 rounded-xl p-3 text-center">
                ...
                <p className="text-xs text-cyan-300 font-medium mb-1">Pro Features</p>
            ...
            {!isCollapsed && (
              <div className="space-y-3">
                <div className="text-xs text-muted-foreground">
                  <p className="text-xs font-medium text-muted-foreground mb-1">Welcome!</p>
